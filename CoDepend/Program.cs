...
public class Program
{
    ...
    public static async Task<string> CLI(string configPath, string format = "puml", bool diff = false)
    {
        try
        {
            ...
            var snapshotManager = SnapshotManagerFactory.SelectSnapshotManager(configManager.GetSnapshotOptions(), logger);
            ...
            var useCase = new UpdateGraphUseCase(configManager, parsers, renderer, snapshotManager, logger, diff);
