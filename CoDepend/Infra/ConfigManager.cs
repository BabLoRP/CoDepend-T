...
#pragma warning restore CA1859 // Use concrete types when possible for improved performance
    ...
    _baseOptions ?? throw new InvalidOperationException("LoadAsync must be called first.");

    public ParserOptions GetParserOptions() => 
        _parserOptions ?? throw new InvalidOperationException("LoadAsync must be called first.");

    public RenderOptions GetRenderOptions() => 
        _renderOptions ?? throw new InvalidOperationException("LoadAsync must be called first.");

    public SnapshotOptions GetSnapshotOptions() => 
        _snapshotOptions ?? throw new InvalidOperationException("LoadAsync must be called first.");
}
